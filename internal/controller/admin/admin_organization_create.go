...
// Create 新建
func (c *ControllerOrganization) Create(ctx context.Context, req *organization.CreateReq) (res *organization.CreateRes, err error) {
	lastInsertId, err := service.Organization().Create(ctx, dto.OrganizationCreateInput{
	...
	return &organization.CreateRes{Id: lastInsertId}, nil
}
