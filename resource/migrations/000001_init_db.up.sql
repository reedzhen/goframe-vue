...
CREATE TABLE `pay_order` (
  ...
  `channel_code` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '渠道编码 例如:alipay_pc/wx_lite',
  ...
  `channel_user_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '渠道用户编号',
  `channel_order_no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '渠道订单号',
...
CREATE TABLE `pay_refund` (
  ...
  `no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '退款单号',
  `app_id` bigint NOT NULL DEFAULT '0' COMMENT '应用ID',
  `channel_id` bigint NOT NULL DEFAULT '0' COMMENT '渠道ID',
  `channel_code` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '渠道编码 例如:alipay_pc/wx_lite',
  `pay_order_id` bigint NOT NULL DEFAULT '0' COMMENT '支付订单ID',
  `pay_order_no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '支付订单编号',
  ...
  `notify_url` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '异步通知商户地址',
...
CREATE TABLE `sys_config` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `group` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '配置分组',
  `label` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '中文名称 例如:姓名',
  `key` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '配置键名 例如:age',
  `value` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '配置值 例如:18',
  `default_value` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '默认值',
  `type` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '类型 string,int,uint,bool,datetime,date\n',
...
CREATE TABLE `sys_cron` (
  ...
  `tag` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '标签 字典表获取',
  `api_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '接口地址',
  `api_param` json DEFAULT NULL COMMENT '接口请求参数',
  `api_header` json DEFAULT NULL COMMENT '接口请求头',
  `pattern` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'cron表达式',
  `status` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '1' COMMENT '任务状态 active运行中/inactive已结束',
...
CREATE TABLE `sys_cron_record` (
  ...
  `output` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '执行结果或输出，可能包括错误信息',
  `status` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '执行状态 success成功/failure失败',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '备注',
  `created_at` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `sys_dept` (
  ...
  `dept_code` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '部门编码',
  `dept_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '部门名称',
  `status` tinyint NOT NULL DEFAULT '1' COMMENT '部门状态 1正常/2停用',
  `level` int NOT NULL COMMENT '关系树层级',
  `tree` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '关系树',
  `sort` int NOT NULL DEFAULT '0' COMMENT '排序',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '备注',
  `created_by` bigint NOT NULL DEFAULT '0' COMMENT '添加人',
  `created_at` datetime DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE `sys_email_record` (
  ...
  `title` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '邮件标题',
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '邮件内容',
  `receiver` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '收件邮箱',
  `sender` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '发件邮箱',
  `create_user_id` int DEFAULT NULL COMMENT '创建人',
  `note` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '备注',
...
CREATE TABLE `sys_file_record` (
  ...
  `name` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '文件名称',
  `path` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '文件存储路径',
  `length` int NOT NULL DEFAULT '0' COMMENT '文件大小',
  `type` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'img' COMMENT '文件类型：img图片/file文件',
  `note` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '备注',
...
CREATE TABLE `sys_login_record` (
  ...
  `username` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '用户账号',
  `os` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '操作系统',
  `device` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '设备名',
  `browser` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '浏览器类型',
  `ip` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'ip地址',
  `ip_city` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'ip归属地',
  `login_type` int unsigned NOT NULL DEFAULT '0' COMMENT '操作类型 1登录成功/2登录失败/3退出登录',
  `remark` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '备注',
  `created_at` datetime DEFAULT NULL COMMENT '创建时间',
  `updated_at` datetime DEFAULT NULL COMMENT '更新时间',
  `tenant_id` bigint NOT NULL DEFAULT '0' COMMENT '租户ID',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `tenant_id` (`tenant_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=416 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='菜单';
...
INSERT INTO `sys_menu` (`id`, `parent_id`, `title`, `path`, `component`, `menu_type`, `sort`, `authority`, `api_path`, `icon`, `hide`, `menu_meta`, `tenant_id`, `deleted_at`, `created_by`, `created_at`, `updated_by`, `updated_at`) VALUES (404, 301, '配置管理', '/system/config', '/system/config', 1, 9, 'sys:config:list', '[\"get:/admin-api/config/module/list\",\"get:/admin-api/config/item/page\",\"get:/admin-api/config/value/get\"]', 'IconProSettingOutlined', 2, '{\"hideFooter\":true, \"lang\": {\"zh_TW\": \"配置管理\", \"en\": \"Config\"}}', 1, NULL, 0, NULL, 0, NULL);
INSERT INTO `sys_menu` (`id`, `parent_id`, `title`, `path`, `component`, `menu_type`, `sort`, `authority`, `api_path`, `icon`, `hide`, `menu_meta`, `tenant_id`, `deleted_at`, `created_by`, `created_at`, `updated_by`, `updated_at`) VALUES (405, 404, '查询配置模块', '', '', 2, 1, 'sys:config:module:list', '[\"get:/admin-api/config/module/list\"]', '', 2, NULL, 1, NULL, 0, NULL, 0, NULL);
INSERT INTO `sys_menu` (`id`, `parent_id`, `title`, `path`, `component`, `menu_type`, `sort`, `authority`, `api_path`, `icon`, `hide`, `menu_meta`, `tenant_id`, `deleted_at`, `created_by`, `created_at`, `updated_by`, `updated_at`) VALUES (406, 404, '添加配置模块', '', '', 2, 2, 'sys:config:module:save', '[\"post:/admin-api/config/module/create\"]', '', 2, NULL, 1, NULL, 0, NULL, 0, NULL);
INSERT INTO `sys_menu` (`id`, `parent_id`, `title`, `path`, `component`, `menu_type`, `sort`, `authority`, `api_path`, `icon`, `hide`, `menu_meta`, `tenant_id`, `deleted_at`, `created_by`, `created_at`, `updated_by`, `updated_at`) VALUES (407, 404, '修改配置模块', '', '', 2, 3, 'sys:config:module:update', '[\"post:/admin-api/config/module/update\"]', '', 2, NULL, 1, NULL, 0, NULL, 0, NULL);
INSERT INTO `sys_menu` (`id`, `parent_id`, `title`, `path`, `component`, `menu_type`, `sort`, `authority`, `api_path`, `icon`, `hide`, `menu_meta`, `tenant_id`, `deleted_at`, `created_by`, `created_at`, `updated_by`, `updated_at`) VALUES (408, 404, '删除配置模块', '', '', 2, 4, 'sys:config:module:remove', '[\"post:/admin-api/config/module/delete/{Id}\"]', '', 2, NULL, 1, NULL, 0, NULL, 0, NULL);
INSERT INTO `sys_menu` (`id`, `parent_id`, `title`, `path`, `component`, `menu_type`, `sort`, `authority`, `api_path`, `icon`, `hide`, `menu_meta`, `tenant_id`, `deleted_at`, `created_by`, `created_at`, `updated_by`, `updated_at`) VALUES (409, 404, '查询配置项', '', '', 2, 5, 'sys:config:item:list', '[\"get:/admin-api/config/item/page\"]', '', 2, NULL, 1, NULL, 0, NULL, 0, NULL);
INSERT INTO `sys_menu` (`id`, `parent_id`, `title`, `path`, `component`, `menu_type`, `sort`, `authority`, `api_path`, `icon`, `hide`, `menu_meta`, `tenant_id`, `deleted_at`, `created_by`, `created_at`, `updated_by`, `updated_at`) VALUES (410, 404, '添加配置项', '', '', 2, 6, 'sys:config:item:save', '[\"post:/admin-api/config/item/create\"]', '', 2, NULL, 1, NULL, 0, NULL, 0, NULL);
INSERT INTO `sys_menu` (`id`, `parent_id`, `title`, `path`, `component`, `menu_type`, `sort`, `authority`, `api_path`, `icon`, `hide`, `menu_meta`, `tenant_id`, `deleted_at`, `created_by`, `created_at`, `updated_by`, `updated_at`) VALUES (411, 404, '修改配置项', '', '', 2, 7, 'sys:config:item:update', '[\"post:/admin-api/config/item/update\"]', '', 2, NULL, 1, NULL, 0, NULL, 0, NULL);
INSERT INTO `sys_menu` (`id`, `parent_id`, `title`, `path`, `component`, `menu_type`, `sort`, `authority`, `api_path`, `icon`, `hide`, `menu_meta`, `tenant_id`, `deleted_at`, `created_by`, `created_at`, `updated_by`, `updated_at`) VALUES (412, 404, '删除配置项', '', '', 2, 8, 'sys:config:item:remove', '[\"post:/admin-api/config/item/delete/{Id}\"]', '', 2, NULL, 1, NULL, 0, NULL, 0, NULL);
INSERT INTO `sys_menu` (`id`, `parent_id`, `title`, `path`, `component`, `menu_type`, `sort`, `authority`, `api_path`, `icon`, `hide`, `menu_meta`, `tenant_id`, `deleted_at`, `created_by`, `created_at`, `updated_by`, `updated_at`) VALUES (413, 404, '查询配置值', '', '', 2, 9, 'sys:config:value:list', '[\"get:/admin-api/config/value/get\"]', '', 2, NULL, 1, NULL, 0, NULL, 0, NULL);
INSERT INTO `sys_menu` (`id`, `parent_id`, `title`, `path`, `component`, `menu_type`, `sort`, `authority`, `api_path`, `icon`, `hide`, `menu_meta`, `tenant_id`, `deleted_at`, `created_by`, `created_at`, `updated_by`, `updated_at`) VALUES (414, 404, '保存配置值', '', '', 2, 10, 'sys:config:value:save', '[\"post:/admin-api/config/value/save\"]', '', 2, NULL, 1, NULL, 0, NULL, 0, NULL);
INSERT INTO `sys_menu` (`id`, `parent_id`, `title`, `path`, `component`, `menu_type`, `sort`, `authority`, `api_path`, `icon`, `hide`, `menu_meta`, `tenant_id`, `deleted_at`, `created_by`, `created_at`, `updated_by`, `updated_at`) VALUES (415, 301, '安全配置', '/system/config-safe', '/system/config-safe', 1, 10, 'sys:config-safe:list', '[\"get:/admin-api/config/module/list\",\"get:/admin-api/config/item/page\",\"get:/admin-api/config/value/get\",\"post:/admin-api/config/value/save\"]', 'IconProSettingOutlined', 2, '{\"hideFooter\":true, \"lang\": {\"zh_TW\": \"安全配置\", \"en\": \"SafeConfig\"}}', 1, NULL, 0, NULL, 0, NULL);
...
CREATE TABLE `sys_operation_record` (
  ...
  `module` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '接口模块 例如：用户管理',
  `summary` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '接口描述 例如：添加用户',
  `param` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '请求参数',
  `json_result` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '返回结果',
  `error_msg` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '异常信息',
  `spend_time` bigint NOT NULL DEFAULT '0' COMMENT '消耗时间, 单位毫秒',
  `trace_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT 'trace_id',
  `status` int NOT NULL DEFAULT '0' COMMENT '状态 1成功/2异常',
  `platform` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '平台 admin/api/open',
  `user_agent` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '请求头User-Agent',
  `ip` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '主机地址',
...
CREATE TABLE `sys_organization` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `parent_id` bigint NOT NULL DEFAULT '0' COMMENT '上级id, 0是顶级',
  `code` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '机构代码',
  `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '机构名称',
  ...
  `link_man` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '联系人',
  `link_phone` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '联系电话',
  `level` int NOT NULL COMMENT '关系树层级',
  `tree` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '关系树',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '备注',
  `created_by` bigint NOT NULL DEFAULT '0' COMMENT '添加人',
...
CREATE TABLE `sys_role` (
  ...
  `code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '角色标识',
  `level` int NOT NULL DEFAULT '0' COMMENT '关系树等级',
  `tree` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '关系树',
...
INSERT INTO `sys_role_menu` (`id`, `role_id`, `menu_id`, `created_at`, `tenant_id`) VALUES (39, 1, 404, '2026-05-16 23:30:00', 0);
INSERT INTO `sys_role_menu` (`id`, `role_id`, `menu_id`, `created_at`, `tenant_id`) VALUES (40, 1, 405, '2026-05-16 23:30:00', 0);
INSERT INTO `sys_role_menu` (`id`, `role_id`, `menu_id`, `created_at`, `tenant_id`) VALUES (41, 1, 406, '2026-05-16 23:30:00', 0);
INSERT INTO `sys_role_menu` (`id`, `role_id`, `menu_id`, `created_at`, `tenant_id`) VALUES (42, 1, 407, '2026-05-16 23:30:00', 0);
INSERT INTO `sys_role_menu` (`id`, `role_id`, `menu_id`, `created_at`, `tenant_id`) VALUES (43, 1, 408, '2026-05-16 23:30:00', 0);
INSERT INTO `sys_role_menu` (`id`, `role_id`, `menu_id`, `created_at`, `tenant_id`) VALUES (44, 1, 409, '2026-05-16 23:30:00', 0);
INSERT INTO `sys_role_menu` (`id`, `role_id`, `menu_id`, `created_at`, `tenant_id`) VALUES (45, 1, 410, '2026-05-16 23:30:00', 0);
INSERT INTO `sys_role_menu` (`id`, `role_id`, `menu_id`, `created_at`, `tenant_id`) VALUES (46, 1, 411, '2026-05-16 23:30:00', 0);
INSERT INTO `sys_role_menu` (`id`, `role_id`, `menu_id`, `created_at`, `tenant_id`) VALUES (47, 1, 412, '2026-05-16 23:30:00', 0);
INSERT INTO `sys_role_menu` (`id`, `role_id`, `menu_id`, `created_at`, `tenant_id`) VALUES (48, 1, 413, '2026-05-16 23:30:00', 0);
INSERT INTO `sys_role_menu` (`id`, `role_id`, `menu_id`, `created_at`, `tenant_id`) VALUES (49, 1, 414, '2026-05-16 23:30:00', 0);
INSERT INTO `sys_role_menu` (`id`, `role_id`, `menu_id`, `created_at`, `tenant_id`) VALUES (50, 1, 415, '2026-05-17 00:00:00', 0);
COMMIT;
...
CREATE TABLE `sys_tenant` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `tenant_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '租户名称',
  `link_id` bigint NOT NULL DEFAULT '0' COMMENT '联系人ID sys_user.id',
  `link_man` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '联系人姓名',
  `link_phone` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '联系人手机',
  `status` tinyint NOT NULL DEFAULT '1' COMMENT '租户状态 1正常/2停用',
  `website` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '绑定域名',
...
CREATE TABLE `sys_tenant_package` (
  ...
  `menu_ids` varchar(4096) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '菜单ID 逗号分隔',
...
CREATE TABLE `sys_user` (
  ...
  `salt` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '盐加密',
  `role_id` bigint NOT NULL DEFAULT '0' COMMENT '角色Id',
  ...
  `id_card` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '身份证号',
  `birthday` date DEFAULT NULL COMMENT '出生日期',
  `introduction` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '个人简介',
